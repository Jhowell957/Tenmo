...
namespace TenmoServer.DAO
{
    ...
    {
        // have DAO for each major table in DB
        ...
        public List<Transfer> GetAllTransfers(int userId)
        {
            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))// no need to open multiple connections ; re instantiate command with new string; tradeoff debate
                {
                    connection.Open();
