...
namespace TenmoServer.Controllers
{
    ...
    public class TransferController : ControllerBase
    {
        ...
        // split controller between transfers and Accounts

        [HttpGet("userid/{userId}")]// dont base code written on current structure assume ongoing addition of implementation
